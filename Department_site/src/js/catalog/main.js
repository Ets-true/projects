$(document).ready(function () {
    ...
    // document.querySelector("#document").href="../media/files/2.docx"
    // document.querySelector("#document").innerHTML = "2.docx"
      ...
      element.addEventListener('click', function () {
        ...
        document.querySelector("body").style.overflowX = "hidden";
          ...
          if(result){
              ...
              document.querySelector("#document").innerHTML = element.id + ".docx"
          } else {
